      ...
      <div className="team3-max-width thq-section-max-width">
        <div className="team3-section-title">
          <span className="thq-body-small">
            {props.content1 ?? (
              <Fragment>
                <span className="team3-text39">Join Our Team Today!</span>
              </Fragment>
            )}
          </span>
          <div className="team3-content1">
            <h2 className="thq-heading-2">
              {props.heading1 ?? (
                <Fragment>
                  <span className="team3-text43">Our team</span>
                </Fragment>
              )}
            </h2>
                ...
                <div className="team3-content4">
                  <div className="team3-title1">
                    <span className="team3-text13 thq-body-small">
                      {props.member1 ?? (
                        <Fragment>
                          <span className="team3-text38">Full name</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.member1Job ?? (
                        <Fragment>
                          <span className="team3-text30">Job title</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                ...
                <div className="team3-content5">
                  <div className="team3-title2">
                    <span className="team3-text16 thq-body-small">
                      {props.member2 ?? (
                        <Fragment>
                          <span className="team3-text37">Full name</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.member2Job ?? (
                        <Fragment>
                          <span className="team3-text34">Job title</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                ...
                <div className="team3-content6">
                  <div className="team3-title3">
                    <span className="team3-text19 thq-body-small">
                      {props.member3 ?? (
                        <Fragment>
                          <span className="team3-text31">Full name</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.member3Job ?? (
                        <Fragment>
                          <span className="team3-text33">Job title</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
                ...
                <div className="team3-content7">
                  <div className="team3-title4">
                    <span className="team3-text22 thq-body-small">
                      {props.member4 ?? (
                        <Fragment>
                          <span className="team3-text40">Full name</span>
                        </Fragment>
                      )}
                    </span>
                    <span className="thq-body-small">
                      {props.member4Job ?? (
                        <Fragment>
                          <span className="team3-text32">Job title</span>
                        </Fragment>
                      )}
                    </span>
                  </div>
          ...
          <div className="team3-content8">
            <div className="team3-content9">
              <h2 className="thq-heading-2">
                {props.heading2 ?? (
                  <Fragment>
                    <span className="team3-text41">We’re hiring!</span>
                  </Fragment>
                )}
              </h2>
            ...
            <button className="team3-button thq-button-filled">
              <span className="team3-text27 thq-body-small">
                {props.actionContent ?? (
                  <Fragment>
                    <span className="team3-text29">Open positions</span>
                  </Fragment>
                )}
              </span>
            </button>
